...
<html lang="en">
  	...
  	<body id="mainBody" onload="defaultSetup()" data-spy="scroll" data-target=".navbar" data-offset="80">
  	<!--Navigation Bar-->
	  	...
	  	<div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="myNavbar">
		      	<ul class="nav navbar-nav">
	        		...
	        		<li class="dropdown" data-toggle="popover" 
						data-content="Click here for more details"
	        			...
	        			<ul class="dropdown-menu">
		            		<li><a href="#cottage">Cottages</a></li>
		            		<li><a href="#regroom">Regular Rooms</a></li>
		            		<li><a href="#grandroom">Grande Rooms</a></li> 
		            		<li><a href="#suproom">Supreme Rooms</a></li> 
		          		</ul>
	        		</li>
		...
		<div class="panel-body">
			...
			<?php
				if(empty($_SESSION['admin'])) {
					...
					echo "<button class='btn btn-success btn-lg' disabled='true'>
						<span class='glyphicon glyphicon-shopping-cart'></span>
						Proceed to Payment
					</button>";
				}
